...
class EffectRateDirToAgent extends StatefulWidget {
  const EffectRateDirToAgent({Key? key}) : super(key: key);

  @override
  _EffectRateDirToAgentState createState() => _EffectRateDirToAgentState();
}

class _EffectRateDirToAgentState extends State<EffectRateDirToAgent> {
