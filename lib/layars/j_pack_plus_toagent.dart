...
import 'package:sales_calculator/layars/k_effect_rate_directtoagent.dart';
import 'package:sales_calculator/moduls/xmoduls.dart';
import 'package:sales_calculator/widgets/xwidgets.dart';

class BuatPackPlusToAgent extends StatefulWidget {
  const BuatPackPlusToAgent({Key? key}) : super(key: key);

  @override
  _BuatPackPlusToAgentState createState() => _BuatPackPlusToAgentState();
}

class _BuatPackPlusToAgentState extends State<BuatPackPlusToAgent> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Responsive(
          mobile: _MobileBuatPackPlusToAgent(
...
class _MobileBuatPackPlusToAgent extends StatefulWidget {
  final TrackingScrollController? controller;
  const _MobileBuatPackPlusToAgent({Key? key, this.controller})
      : super(key: key);

  @override
  State<_MobileBuatPackPlusToAgent> createState() =>
      _MobileBuatPackPlusToAgentState();
}

class _MobileBuatPackPlusToAgentState
    extends State<_MobileBuatPackPlusToAgent> {
  ...
  _MobileBuatPackPlusToAgentState({this.roomType});
